...
#define BattMonitor2            // NEED BattMonitor defined. Use the for speed optimized Battery Monitoring.
...
#define BattCustomConfig DEFINE_BATTERY(2, 0, 14.917, 0.76, BM_NOPIN, 0, 0),DEFINE_BATTERY(3, 1, 14.917, 0, BM_NOPIN, 0, 0)
